\chapter{Experimental Setup}\label{experimental_setup}
	...
	\section{Measurement result}\label{measurement_result}
		...
		\end{figure}							
			...
			Figures \ref{fig:aqauarium_result}, \ref{fig:aquarium_result_high_conc} and \ref{fig:aeolotron_result} show different images captured using a bubble generator in two different water tanks. For low bubble concentrations, images look very similar across the two different setups. 
