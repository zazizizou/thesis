\chapter{The Algorithm} \label{the_algorithm}
	...
	\subsection{Signal extraction}
		...
		\begin{figure}
			...
			\caption{Architecture of BubbleNet. Numbers in parentheses refer to the receptive field. Numbers inside layers are the layer size. The chosen activation function is Relu. Both MaxPool layers have a pool size of 2.}
			\label{fig:cnn_arch}
