...
%Non-trainable params: 0
	...
	\section{Calibration}\label{calibration_algorithm}
		\subsection{Depth of Field}
			...
			Furthermore, blurriness depends on the radius. For instance, larger bubbles tend to be visible for a larger distances from focal plane (up to 10 centimeters), whereas small bubbles are only visible for no more than 2 centimeters. Figure \ref{subfig:depth_calib_meas} shows measured blurriness (in terms of $\sigma$) as a function of radius and distance from focal plane. 
